...
class MainWindow():
    ...
    def populate(self):
        ...
        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        self.check = Gtk.CheckButton("Moon"); self.check.set_active(True)
        self.check.connect("toggled", self.moon_toggle)
        hbox.pack_start(self.check, 0, 0, 0)
        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)

        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        self.check2 = Gtk.CheckButton("Holiday"); self.check2.set_active(True)
        self.check2.connect("toggled", self.holy_toggle)
        hbox.pack_start(self.check2, 0, 0, 0)

        hbox.pack_start(Gtk.Label(" "), 1, 1, 0)
        bbb6 = Gtk.Button(" Day "); bbb6.connect("clicked", self.weekview)
        hbox.pack_start(bbb6, 0, 0, 0)
        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        bbb7 = Gtk.Button(" Week "); bbb7.connect("clicked", self.weekview)
        ...
        hbox.pack_start(Gtk.Label(" "), 1, 1, 0)
        bbb8 = Gtk.Button(" Month "); bbb6.connect("clicked", self.weekview)
        hbox.pack_start(bbb8, 0, 0, 0)
        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        bbb9 = Gtk.Button(" Year "); bbb7.connect("clicked", self.weekview)
        hbox.pack_start(bbb9, 0, 0, 0)

        hbox.pack_start(Gtk.Label(" "), 1, 1, 0)

        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        self.check3 = Gtk.CheckButton("Personal"); self.check3.set_active(True)
        hbox.pack_start(self.check3, 0, 0, 0)
        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)

        hbox.pack_start(Gtk.Label(" "), 0, 0, 0)
        self.check4 = Gtk.CheckButton("Work"); self.check4.set_active(True)
